...
![jmeter进行性能测试配置-tg.png](..\..\resource\screenshot\jmeter3.png)
    `numbers of Threads` 代表同时执行的线程数量
    `ramp-up periods` 代表每间隔多久启动新的线程
    `loop count`  代表循环执行次数

* **在`Thread Group`创建一个如图的样本，一般是http请求**
![jmeter-创建一个样本用于测试.png](..\..\resource\screenshot\jmeter-2.png)

* **创建监听器**

可以根据需要创建多个监听器，也可以加一些统计的图表
![jmeter创建一个监听器.png](..\..\resource\screenshot\jmeter1.png)

* 运行测试
![jmeter运行测试.png](..\..\resource\screenshot\jmeter4.png)
